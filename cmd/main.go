...
import (
	...
	"github.com/shophub-platform/shop-operator/internal/controller"
)
...
func init() {
	...
	utilruntime.Must(shopv1alpha1.AddToScheme(scheme))
}
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "shop-operator.shophub.io",
	})
	if err != nil {
